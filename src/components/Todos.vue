        ...
        <div class="flex flex-col w-full max-w-3xl mt-4 md:mt-0">
          ...
          <div class="flex flex-row justify-between mt-5 border-b border-b-gray-100">
            ...
            <div class="mb-px">
              ...
              >
                <h4 class="text-xs" style="color: rgba(242, 153, 74, 1)">
                  pending
                </h4>
              </div>
            </div>
            <div class="flex gap-1 mb-px">
              ...
              <h4 class="text-xs" style="color: #5c626d">Minor</h4>
            </div>
            <div class="mb-px">
              <img src="@/assets/faces2.svg" />
            </div>
            <div class="mb-px">
          ...
          <div class="flex flex-row justify-between  mt-5 border-b border-b-gray-100">
            ...
            <div class="mb-px">
              <div
                class="border rounded-xl px-3"
                style="background-color: rgba(86, 204, 242, 0.2)"
              >
                <h4 class="text-xs" style="color: rgba(86, 204, 242, 1)">
                  In Progress
                </h4>
              </div>
            </div>
